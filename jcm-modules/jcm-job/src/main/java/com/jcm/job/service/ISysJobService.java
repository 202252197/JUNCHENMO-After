...
public interface ISysJobService {
     ...
     * @return 定时任务调度
     */
    SysJob selectSysJobByJobId(Long jobId);
     ...
     * @return 结果
     */
    int updateSysJob(SysJob sysJob) throws SchedulerException, TaskException;
     ...
     * @return 结果
     */
    void deleteSysJobByJobIds(Long[] jobIds) throws SchedulerException;
     ...
     * @return 结果
     */
    int deleteSysJobByJobId(Long jobId);
