...
public class OperLogCover {
    ...
    public static void insertLogMsg(String BUSINESS_NAME,String context){
        LogAspect.LOG_DESCRIPTION_LOCAL.set(INSERT+BUSINESS_NAME+StyleCover.getStyleSpan(StyleClassConstant.HEIGHT_LIGHT_SPAN, context));
    }


    //删除信息
    public static void deleteLogMsg(String BUSINESS_NAME,Integer size){
        LogAspect.LOG_DESCRIPTION_LOCAL.set(DELECT+StyleCover.getStyleSpan(StyleClassConstant.HEIGHT_LIGHT_SPAN, String.valueOf(size))+"条"+BUSINESS_NAME+"信息");
    }


    //修改信息
    public static void updateLogMsg(String BUSINESS_NAME,Long Id){
        LogAspect.LOG_DESCRIPTION_LOCAL.set(BUSINESS_NAME+"ID: "+StyleCover.getStyleSpan(StyleClassConstant.HEIGHT_LIGHT_SPAN, String.valueOf(Id))+UPDATE);
    }
}
